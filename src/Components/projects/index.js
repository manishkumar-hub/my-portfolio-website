        ...
        <div data-aos="slide-up" id='projects'>
            ...
            <div className='container project-cont'>
                <div className='project-card'>
                    <ProjectCard title={"The Craft House"} subtitle={"An Ecommerce website"} tech={"MERN & Paytm API"} imgSRC={require('../../assets/img/proj1.png')} desc={"The Craft House is a fully responsive, secure ecommerce web application having variety of local and handmade art and craft products .It also has integrated Paytm Payment Gate… "} githubLink={"https://github.com/manishkumar-hub/The-craft-House"} web={true} weblink={"https://the-craft-house.vercel.app/"} />
                </div>
                <div>
